...
% -*- coding: UTF-8; -*-
% vim: set fenc=utf-8
%  Important: maximum poster size: 180cm x 120cm (width x height)  is within the A0 paper size, an international ISO 216 standard paper size (841 × 1189 mm), which results in an area of approximately 1 m²
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{document}
\conference{\Conference - \Acknowledgments}
...
%	\begin{multicols}{2}
%%	\linespread{1.0} 
%	 \begin{spacing}{.5\baselinestretch} 
%		{\tiny
%		%\boldmath
%			\Abstract
%		}
